...
COPY ui/material-admin-pro/ui-bundle/src/js/vendor/scripts.js /usr/local/apache2/htdocs/js/scripts.js
COPY ui/material-admin-pro/ui-bundle/src/js/vendor/material.js /usr/local/apache2/htdocs/js/material.js
