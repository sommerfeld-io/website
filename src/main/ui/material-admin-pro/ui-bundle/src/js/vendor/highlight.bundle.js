;(function () {
  ...
  hljs.registerLanguage('make', require('highlight.js/lib/languages/makefile'))
  ...
  hljs.registerLanguage('vagrant', require('highlight.js/lib/languages/groovy'))
  hljs.registerLanguage('vagrantfile', require('highlight.js/lib/languages/groovy'))
